...
const svetRedTop = `${import.meta.env.BASE_URL}images/phoneTop.png`;
const svetRedBottom = `${import.meta.env.BASE_URL}images/phoneBottom.png`;
const menuIcon = `${import.meta.env.BASE_URL}images/video-final-menu-icon.svg`;
const statusBar = `${import.meta.env.BASE_URL}images/video-final-statusbar.png`;
const balanceIcon = `${import.meta.env.BASE_URL}images/video-final-balance-icon.svg`;
const buttonBackground = `${import.meta.env.BASE_URL}images/video-final-button-bg.svg`;
const sendIcon = `${import.meta.env.BASE_URL}images/video-final-send-icon.svg`;
...
interface VideoFinalScreenProps {
  onBackToMain: () => void;
}

export const VideoFinalScreen: FC<VideoFinalScreenProps> = ({ onBackToMain }) => {
  return (
    <Screen>
      <BackgroundLayer>
